...
public:
	...
	explicit image_widget(const variant& v, game_logic::FormulaCallable* e);
...
public:
	...
	explicit gui_section_widget(const variant& v, game_logic::FormulaCallable* e);
...
typedef boost::intrusive_ptr<gui_section_widget> gui_section_WidgetPtr;
