...
public:
	...
	graphical_font_label(const variant& v, game_logic::FormulaCallable* e);

	void setText(const std::string& text);
	void resetText_dimensions();
...
typedef boost::intrusive_ptr<graphical_font_label> graphical_font_LabelPtr;
