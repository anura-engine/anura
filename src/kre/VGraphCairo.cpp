...
namespace KRE
{
	namespace Vector
	{
		...
		public:
			...
			std::string asString() const override { return "cubic_b√©zier"; }
		private:
			enum {
		...
		public:
			...
			std::string asString() const override { return "quadratic_b√©zier"; }
		private:
			enum {
		...
		public:
			...
			// Adds a Cubic BÈzier curve to the current path from the current position to the end position
			...
			// Adds a Quadratic BÈzier curve to the current path from the current position to the end position
