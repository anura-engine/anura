...
* Unit Tests
  * KNOWN BROKEN [Windows /
    msbuild](https://github.com/anura-engine/anura/blob/trunk/.github/workflows/pr-unit-tests-static-windows.yaml)
  * KNOWN BROKEN [macOS /
    xcodebuild](https://github.com/anura-engine/anura/blob/trunk/.github/workflows/pr-unit-tests-static-macos.yaml)
  * [Ubuntu 22.04 /
